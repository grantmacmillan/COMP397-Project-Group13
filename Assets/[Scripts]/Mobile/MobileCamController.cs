...
class MobileCamController : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (Input.touchCount >= 1)
        {
            ...
            if (Camera.transform.position.x < panRangeX.x) Camera.transform.position = new Vector3(panRangeX.x, Camera.transform.position.y, Camera.transform.position.z);
            if (Camera.transform.position.x > panRangeX.y) Camera.transform.position = new Vector3(panRangeX.y, Camera.transform.position.y, Camera.transform.position.z);
            if (Camera.transform.position.z < panRangeZ.x) Camera.transform.position = new Vector3(Camera.transform.position.x, Camera.transform.position.y, panRangeZ.x);
            if (Camera.transform.position.z > panRangeZ.y) Camera.transform.position = new Vector3(Camera.transform.position.x, Camera.transform.position.y, panRangeZ.y);
        }
